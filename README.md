...
Since it is routine for me to spend lot of my labor hours in an air-gapped environment, a docker image seems to be the best way to package some of my favorite tools.  
